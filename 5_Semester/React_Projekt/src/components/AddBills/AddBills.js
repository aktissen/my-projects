...
export default function AddBills() {
  ...
  const updateContext = (e) => {
    ...
    let newBill = {};
    let lastItem =
      userInfo[0].animals[id].bills[userInfo[0].animals[id].bills.length - 1];
    ...
    completeUserInfo[0].animals[id].bills.push(newBill);
    ...
    <div>
      ...
      <div className="container-circle">
        <div className="row">
          ...
          <h5 className="font-link">Neue Rechnung</h5>
        </div>
        <div>
          <form
